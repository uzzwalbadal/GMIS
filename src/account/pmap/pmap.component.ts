...
import { LeafletLayersDemoModel } from '../../gmis/map/layers-demo.model';
...
@Component({
  ...
  styles: [`input[type="radio"]:checked {
...
export class PmapComponent  {
  ...
  IPCommandArea:any;
    ...
    ipCommand = {
      ...
      layer: geoJSON(
        ...
        {
          onEachFeature: this.pop_IPCommandArea_3.bind(this), style: () => ({ opacity: 1,
    ...
    headWorks = {
      ...
      layer: geoJSON(
        ...
        {
          onEachFeature: this.pop_IPHeadworks_5.bind(this), style: () => ({ radius: 4.0,
            opacity: 1,
            color: 'rgba(35,35,35,1.0)',
            dashArray: '',
            lineCap: 'butt',
    ...
    ipCanal = {
      ...
      layer: geoJSON(
        (this.IPCanal) as any,
        {
          onEachFeature: this.pop_IPHeadworks_5.bind(this), style: () => ({opacity: 1,
  ...
  constructor(private zone: NgZone,private geoService:GeoJsonService) {
//     this.geoService.getGeoJson('./../assets/geojson/DistrictsofNepal.json').subscribe((data: any) => {
//       this.Districts =  data;
//       this.district1.layer.addData(data);
//       this.apply();
// });
//     this.geoService.getGeoJson('./../assets/geojson/IPCommandArea_3.json').subscribe((data: any) => {
//       this.IPCommandArea =  data;
//       this.ipCommand.layer.addData(data);
//       this.apply();
// });
//       this.geoService.getGeoJson('./../assets/geojson/IPCanalNetwork.json').subscribe((data: any) => {
//       this.IPCanal =  data;
//       this.ipCanal.layer.addData(data);
//       this.apply();
// });
     
//       this.geoService.getGeoJson('./../assets/geojson/IPHeadworks.json').subscribe((data: any) => {
//       this.IPHeadWorks =  data;
//       this.headWorks.layer.addData(data);
//       this.apply();
// });
...
this.apply();
   ...
   pop_IPCanalNetwork_4(feature, layer) {
    var popupContent = '<table>\
            <tr>\
                <th scope="row"></th>\
